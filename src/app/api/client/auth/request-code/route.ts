...
export async function POST(req: NextRequest) {
  ...
  after(async () => {
    try {
      ...
      await sendMail({ to: client.email, subject: "Votre code de connexion — Lotier Immobilier", html: renderBrandedEmail({ subject: "Votre code de connexion", contentHtml: content }) });
    } catch { /* journalisé par le mailer */ }
  });
